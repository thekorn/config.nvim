...
vim.keymap.set("n", "<leader>rN", function() require("snacks").rename.rename_file() end,
    { desc = "Fast Rename Current File" })
vim.keymap.set("n", "<leader>dB", function() require("snacks").bufdelete() end,
...
-- Git Stuff
vim.keymap.set("n", "<leader>gbr", function() require("snacks").picker.git_branches({ layout = "select" }) end,
    { desc = "Pick and Switch Git Branches" })

-- Other Utils
vim.keymap.set("n", "<leader>th", function() require("snacks").picker.colorschemes({ layout = "ivy" }) end,
